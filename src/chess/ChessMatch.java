...
public class ChessMatch {
    ...
    private void nextTurn(){
        turn++;
        currentPlayer = (currentPlayer == Color.WHITE) ? Color.BLACK : Color.WHITE; //expressão ternária se jogador atual for branco recebe preto senão fica branco
    }

    private Color opponent(Color color){
        return (color == Color.WHITE) ? Color.BLACK : Color.WHITE; //Se a cor que eu passei foi no argumento for Color.WHITE retorna Color.BLACK caso contrário retorna Color.WHITE
    }
    ...
    private void placeNewPiece(char column, int row, ChessPiece piece){
        board.placePiece(piece, new ChessPosition(column,row).toPosition()); //coloca as peças colocando as peças na coordenada do Xadrez
